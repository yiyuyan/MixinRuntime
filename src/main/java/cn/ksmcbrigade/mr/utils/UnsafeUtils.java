...
public class UnsafeUtils {
    ...
    public static void coexistenceCoreAndMod(Class<?> clazz) {
        ...
        String selfPath = UnsafeUtils.getJarPath(clazz);
        Path selfRoot = Path.of(selfPath).toAbsolutePath().normalize();

        Set<Path> locatedPaths = UnsafeUtils.getFieldValue(loader, "locatedPaths", Set.class);
        ...
        List<ModFile> earlyServicesJars = UnsafeUtils.getFieldValue(loader, "earlyServicesJars", List.class);

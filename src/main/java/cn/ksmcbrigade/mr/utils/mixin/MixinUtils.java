...
import cn.ksmcbrigade.mr.transformers.FMLClassTrackerTransformer;
...
public class MixinUtils {
    ...
    public static void fixClassLoader(Instrumentation inst) throws Exception {
        ...
        inst.addTransformer(new FMLClassTrackerTransformer(),true);
        ...
        inst.retransformClasses(Class.forName("net.neoforged.fml.loading.mixin.FMLClassTracker"));
